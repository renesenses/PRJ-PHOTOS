...
# ListBox with YearsRange and an event on selected value in the list
...
sub OnYear {
#    print "ARGS : ",join(", ",@_);
#    my $index = $this->{$event}->{getSelection};
#	print "ANNEE CHOISIE : ","Oui","\n";
#    foreach my $arg ( @_ ) {
 #   	if (ref $_[$arg] = "ARRAY" ) {
  #  		print join(", ", @$$arg 
   # 	print "$arg : ",${$key},"\n";
...
#    print "ANNEE CHOISIE : ",$event->GetSelection,"\n";	 # OK
